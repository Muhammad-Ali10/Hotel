...
export const nav: AppNavEntry[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Restrictions", href: "/extranet/rates/restrictions" },
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Genius Discounts", href: "/extranet/boost/genius" },
      { title: "Long Stays", href: "/extranet/boost/long-stays" },
    ],
  },
  /*
   * No badges here.
   *
   * They were fixed numbers — "7" on the inbox, "25" on reviews — printed
   * beside lists that count something else entirely. A badge that is always
   * wrong is worse than no badge: it is a permanent unread marker nothing can
   * clear, and it teaches people to stop looking.
   *
   * "Guest Communications" is gone too. It showed the same guest conversations
   * as Messages, from a second block of data, so two screens under one menu
   * disagreed about the same threads. Replying to a REVIEW — the other thing
   * it seemed to promise — lives on Guest Reviews, where the reply is public
   * and counts toward the rating.
   */
  {
    title: "Inbox",
    href: "/extranet/inbox",
  ...
  { title: "Guest Reviews", href: "/extranet/reviews", icon: Star },
  {
    title: "Finance",
