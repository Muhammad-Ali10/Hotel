...
/**
 * Destinations the platform can actually take a booking in.
 *
 * This list was sixteen names written into `@/data/locations` — Dubai, Tokyo,
 * Bali, Santorini, Bora Bora, Ibiza — on a catalogue whose live properties are
 * in New York and Paris. Picking any of the other fourteen ran a search that
 * could only return nothing, from the first control on the home page.
 *
 * `GET /destinations` returns the cities with live listings, which is the same
 * list the home page's destination cards are built from — so the suggestion
      ...
      >
        <Command>
          ...
          <CommandList>
            ...
            <CommandGroup heading="Where you can book">
              {(destinations.data ?? []).map((loc) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* The count is the platform's own, so a guest knows what
                        a click will find before they make it. */}
