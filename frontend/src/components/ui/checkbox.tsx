...
/**
 * Indeterminate state gets the same filled treatment as checked, with a dash
 * instead of a tick. Base UI renders the indicator for both states but only
 * stamps `data-checked` when fully checked, so without the
 * `data-indeterminate` rules a mixed selection showed a bare tick on an
 * unfilled box.
 */
