...
import { useNotifications, useProfile } from "@/lib/api/hooks"
...
export function DashboardSidebar({ onNavigate }: { onNavigate?: () => void }) {
  ...
  // never changed it.
  /*
   * The badge reads the same query the notifications page does, so opening
   * the page and clearing it moves this too. It used to read a store the
   * server never saw, and the two agreed with each other while both were
