...
import { usePartnerProperties, useUpdateListing } from "@/lib/api/hooks"
...
export function DescriptionsView() {
  const { data: hotels, isPending, error } = usePartnerProperties()
  const [editing, setEditing] = React.useState<PartnerProperty | null>(null)
          ...
          <Button
            ...
            onClick={() => {
              ...
              update.mutate(
                ...
                {
                  onSuccess: () => {
                    // Not a material field (rule #71) — it goes live at once.
