...
const faqs = [
  {
    ...
    a: "Yes — there's no manual review or approval step. A booking holds the room from the moment the guest starts it and turns confirmed as soon as their payment clears, usually seconds later. You'll see both states in your calendar, and a hold that never clears releases the room on its own.",
  },
  {
