...
export default function PropertyTypePage() {
  ...
  /*
   * `PropertyType` comes from the shared contract, not from a list typed into
   * this folder. The eight names here are the eight the database accepts — a
   * ninth invented in the wizard would be refused at approval, months after the
   * partner chose it.
   */
  async function validate() {
    ...
    return save({ propertyName: name.trim(), propertyType: type })
  }
